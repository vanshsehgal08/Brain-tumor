...
history = model.fit(train_data, validation_data=test_data, epochs=30, verbose=1, callbacks=[callback])

# SAVING THE TRAINED MODEL
save_dir = './trained-model/'
os.makedirs(save_dir, exist_ok=True)
model.save(os.path.join(save_dir, 'tumor_model.h5'))
print("Model saved in './trained-model/tumor_model.h5'")
